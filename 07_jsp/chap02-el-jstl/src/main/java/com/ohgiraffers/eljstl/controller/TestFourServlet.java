...
public class TestFourServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		MemberDTO sessionMember = new MemberDTO("돼지", 200, "010-3333-4444", "pig@ohgiraffers.com");
		MemberDTO requestMember = new MemberDTO("다람쥐", 900, "010-5555-4444", "squirrel@ohgiraffers.com");
