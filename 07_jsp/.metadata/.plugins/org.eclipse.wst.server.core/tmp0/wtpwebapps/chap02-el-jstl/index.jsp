...
<body>
	...
	<h3><a href="views/el/test3.jsp?name=iphone&price=100&no=5&no=6&option=apple">parameter로 값을 전달한 경우 EL test</a></h3>
	<h3><a href="test4">requestScope와 sessionScope 우선순위 테스트</a></h3>
