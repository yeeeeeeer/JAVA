...
public class Application03 {
    public static void main(String[] args) {
         ...
         * 또한 규칙에 맞는 올바른 변수명을 짓는것은 좋은 프로그래밍을 하는 첫 단추이다.
         * */
         ...
         * 1-3. 변수명은 대/소문자를 구분한다. (자바는 대/소문자를 엄격히 구분하는 언어다.)
         ...
         * 2-4. 한글로 변수명을 짓는것은 가능하지만 권장되지 않는다. (한글을 취급하는 다양한 방식이 존재하기 때문에 영어로 작성하는것이 좋다.)
         * 2-5. 변수 안에 저장된 값이 어떤 의미를 가지는지 명확하게 표현하도록 한다.
         * 2-6. 전형적인 변수 이름이 있다면 가급적 사용하도록 한다.
         * 2-7. 명사형으로 작성할 수 있다.
         * 2-8. boolean 형은 의문문으로, 가급적 긍정적으로 네이밍한다.
         * */

        // 1-2. 동일한 범위(main의 중괄호 안을 의미.) 내에서 동일한 변수명을 가질 수 없다.
        int age = 20;
        // int age = 10;
        ...
        // 2-1. 에러를 발생시키진 않지만 개발자들끼리의 암묵적인 규칙
        int asasdflkajsdflkjasdflkjasldkfjasdlk;  // 하지말기
        ...
        String user_name;   //스네이크케이스 사용X
        String username;    //올바른 표현

        // 2-4. 한글로 변수명을 짓는것은 가능하지만 권장하지 않는다.
        int 나이;
        ...
        // 2-8. boolean 형은 의문문, 가급적 긍정형태를 갖는다.
