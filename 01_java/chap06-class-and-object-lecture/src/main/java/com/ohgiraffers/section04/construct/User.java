...
public class User {
     ...
     *
     * 생성자의 사용 목적
     * 1. 인스턴스 생성 시점(new연산자 생성)에 수행할 명령이 있는 경우 사용한다.
     ...
     *
     * 생성자 작성시 주의할 점
     * 1. 생성자 메소드는 반드시 클래스의 이름과 동일해야 한다. (대/소문자까지 동일하게)
     ...
     * 2. 매개변수가 있는 생성자
     * 기본생성자는 자바 컴파일러가 자동으로 추가해주지만 명시적으로 작성도 가능하다.
     * 매개변수 있는 생성자가 한 개라도 존재하는 경우 기본생성자를 자동으로 추가해주지 않기떄문에
     * 기본생성자도 필요한 경우에는 반드시 작성해주어야한다.
     *
     * */
