...
public class Application03 {
    public static void main(String[] args) {
        ...
        /*
         * 문자열 분리하기 기능 **  생각보다 현업에서 많이 쓴다
         * split() : 정규표현식을 이용하여 문자열을 분리한다.
         * 비정형화된 문자열을 분리할 때 좋지만 (공백 문자열 값 포함)*
         * "정규표현식" 을 이용하기 때문에 속도가 느리다는 단점을 가진다.
         *
         * StringTokenizer : 문자열의 모든 문자열으르 "구분자로 하여 문자열을 분리" 한다.
        ...
        StringTokenizer st1 = new StringTokenizer(emp1, "/");  // (구분한문자열, 구분자)
        ...
        String[] colors = colorStr.split("[*#/ ]");     // []대괄호로 묶으면 정규표현식이어도 사용 가능.
