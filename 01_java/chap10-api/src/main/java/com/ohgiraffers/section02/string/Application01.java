...
public class Application01 {
    public static void main(String[] args) {
         ...
         *   인덱스를 벗어난 정수를 인자로 전달하는 경우에는 IndexOutOfBoundException 이 발생한다.
         * */
        ...
        /*
         * compareTo() -> 양수 음수를 알아보기위해 많이 함.
         * : 인자로 전달된 문자열과 사전 순으로 비교를 하여
         * 두 문자열이 같다면 0을 반환, 인자로 전달된 문자열보다 작으면 "음수"를,
         * 크면 "양수"를 반환한다.
        ...
        /*
         * indexOf() :  문자열에서 "특정 문자를 탐색" 하여 처음 일치하는 "인덱스 위치를 정수형으로 변환" 한다.
        ...
        /*
         * lastIndexOf() : "문자열 탐색을 뒤에서부터" 하고 처음일치하는 위치의 인덱스를 반환한다.
        ...
        /*
         * trim() : 문자열의 앞 뒤 "공백을 제거한 문자열" 을 반환한다.
         * */
        String trimStr = "   java   ";
        ...
        /*
         * subString() :  문자열의 "일부분을 잘라내" 새로운 문자열을 반환한다.
         * 원본에 영향 X
         * */
        String javaOracle = "javaOracle";
        System.out.println("subString(3,6) : " + javaOracle.substring(3, 6));
        System.out.println("subString(3) : " + javaOracle.substring(3)); // 숫자 하나면 그 숫자부터 끝까지 나옴
        System.out.println("javaOracle : " + javaOracle);

        /*
         * replace() : 문자열에서 대체할 문자열로 "기존 문자열을 변경" 해서 반환한다.
         * 원본에 영향 X
         * */
