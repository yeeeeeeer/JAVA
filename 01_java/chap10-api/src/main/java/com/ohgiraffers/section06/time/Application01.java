...
public class Application01 {
    public static void main(String[] args) {
        ...
        * time 패키지의 하위 패키지
        *   java.time
        *       .chrono : ISO-8601(국제 표준)에 정의된 달력시스템을 위한 클래스들을 제공한다.
        ...
        * */
        ...
        LocalTime timeOf = LocalTime.of(23, 59, 59);
        System.out.println("timeOf = " + timeOf);

        LocalDate dateNow = LocalDate.now();
        System.out.println("dateNow = " + dateNow);

        LocalDate dateOf = LocalDate.of(2018, 1, 1);
        System.out.println("dateOf = " + dateOf);

        LocalDateTime dateTimeNow = LocalDateTime.now();
        System.out.println("dateTimeNow = " + dateTimeNow);

        LocalDateTime dateTimeOf = LocalDateTime.of(2018, 1, 1, 1, 1);
