package main.java.com.ohgiraffers.section03.springbuilder;
...
public class Application02 {
    public static void main(String[] args) {
        ...
        // capacity() : 용량(현재 버퍼의 크기)를 정수형으로 반환하는 메소드 (문자열 길이 + 16이 기본용량)
        System.out.println(sb1.capacity());

        /*
         * append() : 인자로 전달된 값을 문자열로 변환 후 기존 문자열의 마지막에 추가한다.
         * 기본 용량을 초과하는 경우 (기존 문자열 + 1) * 2 를 하여 "용량을 확장" 시킨다.
         *
         * */
        ...
        /*
         * delete() :  시작 인덱스와 종료 인덱스를 이용해서 문자열에서 "원하는 부분의 문자열을 제거" 한다.
        ...
        /*
         * insert() : 인자로 전달된 값을 문자열로 반환 후 저장된 인덱스 위치에 "추가" 한다.
         * 원본에 영향을 미친다.
         * */
        ...
        /*
        * reverse() : 문자열 "인덱스 순번을 역순" 으로 재배열한다.
        * 원본에 영향을 미친다.
        * */
